...
const config: DocsThemeConfig = {
	logo: <span>NGP Docs</span>,
	project: {
		link: "https://github.com/kevinmichaelchen/nextra-ssg-example",
		icon: repoIcon,
	},
	chat: {
		link: "https://github.com/kevinmichaelchen/nextra-ssg-example/issues",
		icon: chatIcon,
	},
	docsRepositoryBase: "https://github.com/kevinmichaelchen/nextra-ssg-example",
	footer: {
